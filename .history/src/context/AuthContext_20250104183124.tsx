...
const register = async (email: string, password: string): Promise<void> => {
  try {
    ...
    if (error.response) {
      // Si error tiene una respuesta (posible error de Axios o HTTP)
      ...
      // Otro tipo de error (por ejemplo, interno)
      console.error("Error inesperado al crear usuario:", error.message || error);
    }
