...
import { useRouter } from "next/router";  // Para redirigir después de la autenticación
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <AuthComponent setShowModal={setShowModal} /> {/* Aquí pasa setShowModal al componente */}
          </div>
        </div>
      )}
