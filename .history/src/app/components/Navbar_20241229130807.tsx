...
import { useAuth } from "@/context/AuthContext"; // Asegúrate de que el contexto esté correctamente configurado
import { useState } from "react";
import AuthModalContent from "./AuthModalContent";

const Navbar = () => {
  const { user, logout } = useAuth(); // Obtén el estado del usuario desde el contexto
