    ...
    <nav className="p-4 fixed top-0 w-full shadow bg-green-600 text-white z-10">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            className="cart-button relative flex items-center space-x-2 text-white"
            onClick={() => setShowCart(true)}
          >
            <FaShoppingCart size={20} />
            {cart.length > 0 && (
              <span className="cart-counter absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold">
