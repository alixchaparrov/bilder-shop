...
const AuthModalContent = ({ onClose }: { onClose: () => void }) => {
  const { login, register, loginWithGoogle } = useAuth(); // Métodos del contexto de autenticación
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onClose(); // Cierra el modal al iniciar sesión o registrarse correctamente
    } catch (err: any) {
