...
import { auth, db } from "@/lib/firebaseConfig"; // Asegúrate de que 'auth' y 'db' estén importados correctamente
...
const AuthComponent = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      // Una vez el usuario se registre, añadimos su información en Firestore
      await setDoc(doc(db, "users", userCredential.user.uid), {
        email: userCredential.user.email,
        role: "user",  // Asignamos el rol de "user" por defecto
      });
