...
import AuthComponent from "@/app/components/AuthComponent"; // Asegúrate de que el componente AuthComponent esté correctamente importado
      ...
      {showModal && (
        ...
        >
          <div
            ...
            onClick={(e) => e.stopPropagation()} // Previene que el modal se cierre al hacer clic dentro
          >
            <button
              className="absolute top-2 right-2 text-gray-700"
              onClick={() => setShowModal(false)} // Cierra el modal al hacer clic en la "X"
            >
              X
            </button>
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                className="w-full bg-blue-500 text-white py-3 rounded-lg flex items-center justify-center space-x-2 hover:bg-blue-600 transition duration-300"
              >
                <FaGoogle size={20} />
