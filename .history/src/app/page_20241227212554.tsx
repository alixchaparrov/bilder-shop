...
import AdminDashboard from "@/app/components/AdminDashboard"; // Importación del componente AdminDashboard
import { useRouter } from "next/router"; // Para redirigir usuarios no admin
...
export default function Home() {
  ...
  const [user] = useAuthState(auth); // Obtenemos el estado de autenticación del usuario
  ...
  useEffect(() => {
    if (user && user.role !== "admin") {
      router.push("/"); // Redirige a la página de inicio si el usuario no es admin
    }
  }, [user]);
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            <AuthComponent /> {/* Aquí va el formulario de autenticación */}
          </div>
        </div>
      )}
