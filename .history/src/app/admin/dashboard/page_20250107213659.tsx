...
{/* Header */}
<header className={`${darkMode ? "bg-gray-800" : "bg-green-600"} text-white p-4 shadow-md`}>
  <div className="flex justify-between items-center max-w-7xl mx-auto">
    {/* Logo y Título */}
    <div className="flex items-center space-x-4">
      <img
        src="/images/logo.png" // Cambia esta ruta al archivo de tu logo
        alt="Kolumbianische Gemälde Logo"
        className="w-10 h-10" // Ajusta el tamaño del logo
      />
      <h1 className="text-3xl font-extrabold">
        Admin Dashboard <span className="text-xl font-light">| Kolumbianische Gemälde</span>
      </h1>
    </div>
    ...
    <div className="flex items-center space-x-4">
      ...
      <button
        ...
        className={`p-2 rounded-lg shadow-md ${darkMode ? "bg-gray-600" : "bg-yellow-500"} hover:opacity-75`}
      >
        {darkMode ? "🌞" : "🌙"}
      </button>
      ...
      <button
        onClick={logout}
        className="bg-red-500 px-4 py-2 rounded-lg shadow hover:bg-red-600"
      >
        Logout
      </button>
    </div>
