  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSuccess(form.id ? "User updated successfully." : "User added successfully.");
      } else {
        const data = await response.json();
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-grow max-w-7xl mx-auto p-6">
        ...
        {/* Notifications */}
        {error && <div className="bg-red-100 text-red-600 p-4 mb-4 rounded">{error}</div>}
        {success && <div className="bg-green-100 text-green-600 p-4 mb-4 rounded">{success}</div>}
